...
var _user$project$App$completed = function (todos) {
...
var _user$project$App$completedText = function (todos) {
	return _elm_lang$core$Basics$toString(
		_user$project$App$completed(todos));
};
var _user$project$App$remaining = function (todos) {
	return _elm_lang$core$List$length(
		A2(
			_elm_lang$core$List$filter,
			function (todo) {
...
var _user$project$App$remainingText = function (todos) {
	return _elm_lang$core$Basics$toString(
		_user$project$App$remaining(todos));
};
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'ToggleItem':
				var toggleCompleted = function (item) {
					return _elm_lang$core$Native_Utils.eq(item.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						item,
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(_elm_lang$core$List$map, toggleCompleted, model.todos)
					});
			case 'KeyDown':
				return (_elm_lang$core$Native_Utils.eq(_p0._0, 13) && (!_elm_lang$core$Native_Utils.eq(model.input, ''))) ? _elm_lang$core$Native_Utils.update(
					model,
					{
						input: '',
						todos: A2(
							...
							{
								ctor: '::',
								_0: {id: model.uid, text: model.input, completed: false},
								_1: {ctor: '[]'}
							}),
						uid: model.uid + 1
					}) : model;
			...
			case 'DeleteItem':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(_elm_lang$core$List$filter, filterItem, model.todos)
					});
			case 'ToggleFilter':
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$App$Todo = F3(
	function (a, b, c) {
		return {completed: a, text: b, id: c};
	});
var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {todos: a, input: b, uid: c, filter: d};
	});
var _user$project$App$ClearCompleted = {ctor: 'ClearCompleted'};
var _user$project$App$viewClearCompleted = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_user$project$App$completed(model.todos),
		0) > 0) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_user$project$App$ClearCompleted),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('footer_clear'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html$text(
					_user$project$App$completedText(model.todos)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(')'),
					_1: {ctor: '[]'}
...
var _user$project$App$ToggleFilter = function (a) {
	return {ctor: 'ToggleFilter', _0: a};
};
var _user$project$App$viewFiltersButton = F2(
	function (label, activeFilter) {
		var filterClass = _elm_lang$core$Native_Utils.eq(label, activeFilter) ? 'filter filter__active' : 'filter';
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(filterClass),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$App$ToggleFilter(label)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$App$viewFilters = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('footer_filters'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_user$project$App$viewFiltersButton, 'All', model.filter),
			_1: {
				ctor: '::',
				_0: A2(_user$project$App$viewFiltersButton, 'Active', model.filter),
				_1: {
					ctor: '::',
					_0: A2(_user$project$App$viewFiltersButton, 'Completed', model.filter),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$App$viewRemaining = function (model) {
	var numberRemaining = _user$project$App$remainingText(model.todos);
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('footer_content'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('footer_remaining'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(numberRemaining),
							_1: {
								ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _user$project$App$viewFilters(model),
						_1: {
							ctor: '::',
							_0: _user$project$App$viewClearCompleted(model),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$App$viewFooter = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(model.todos),
		0) > 0) ? _user$project$App$viewRemaining(model) : A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'});
};
var _user$project$App$DeleteItem = function (a) {
...
var _user$project$App$viewInput = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$App$onKeyDown(_user$project$App$KeyDown),
							_1: {
								ctor: '::',
...
var _user$project$App$ToggleItem = function (a) {
	return {ctor: 'ToggleItem', _0: a};
};
var _user$project$App$viewTodoItem = function (todo) {
	var liClass = todo.completed ? 'item item__checked' : 'item';
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('item_content'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$App$ToggleItem(todo.id)),
										_1: {
											ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('item_delete'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$App$DeleteItem(todo.id)),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$App$viewTodosList = function (model) {
	...
	var listOfTodos = A2(_elm_lang$core$List$map, _user$project$App$viewTodoItem, filteredTodos);
	return (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(listOfTodos),
		0) > 0) ? A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('todo_list'),
			_1: {ctor: '[]'}
		},
		listOfTodos) : A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('empty_todo_list'),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$App$viewInput(model),
					_1: {
						ctor: '::',
						_0: _user$project$App$viewTodosList(model),
						_1: {
							ctor: '::',
							_0: _user$project$App$viewFooter(model),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$App$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$App$initialModel, view: _user$project$App$view, update: _user$project$App$update})();

var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"App.Msg":{"args":[],"tags":{"DeleteItem":["Int"],"ClearCompleted":[],"ToggleItem":["Int"],"UpdateInput":["String"],"ToggleFilter":["String"],"KeyDown":["Int"]}}},"aliases":{},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
